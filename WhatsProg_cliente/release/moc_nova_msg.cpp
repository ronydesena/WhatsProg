...
void nova_msg::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<nova_msg *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (nova_msg::*)(const string & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&nova_msg::aceitaDestinatario)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject nova_msg::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_nova_msg.data,
    qt_meta_data_nova_msg,
    qt_static_metacall,
    nullptr,
    nullptr
} };
