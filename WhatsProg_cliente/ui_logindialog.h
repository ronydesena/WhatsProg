...
public:
    ...
    {
        LoginDialog->setWindowTitle(QApplication::translate("LoginDialog", "Usuario - Criar", 0));
        label->setText(QApplication::translate("LoginDialog", "*Nome de usu\303\241rio e senha devem ter entre 6 e 12 caracteres", 0));
